...
public class BankTransfers extends org.jooq.impl.TableImpl<server.jooq.tables.records.BankTransfersRecord> {
	 ...
	 */
	public final org.jooq.TableField<server.jooq.tables.records.BankTransfersRecord, java.lang.Boolean> PAID = createField("paid", org.jooq.impl.SQLDataType.BOOLEAN.defaulted(true), this, "");
